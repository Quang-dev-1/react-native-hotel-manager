...
const RoomStatusModal = ({
    ...
    const statusOptions = [
        ...
        { key: 'MAINTENANCE', label: 'Bảo trì', icon: 'time', color: '#3b82f6' },
...
export default function RentalScreen() {
    ...
    const [selectedStatus, setSelectedStatus] = useState<'all' | 'AVAILABLE' | 'OCCUPIED' | 'MAINTENANCE' | 'CLEANING'>('all');
    ...
    const statusColors: Record<string, { bg: string; text: string; icon: string }> = {
        ...
        MAINTENANCE: { bg: '#dbeafe', text: '#1e40af', icon: 'time' },
    ...
    const getStatusStats = () => {
        return {
            ...
            waiting: rooms.filter(r => r.status === 'MAINTENANCE').length,
    ...
    const getHeaderTitle = () => {
        ...
        if (filter === 'waiting') return 'Phòng bảo trì';
            ...
            <ScrollView
                ...
                <View style={styles.roomsGrid}>
                    {filteredRooms.map((room) => {
                        ...
                        const isInteractable = room.status === 'AVAILABLE' ||
